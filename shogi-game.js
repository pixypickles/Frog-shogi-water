...
function launchBattle(m){const attacker=m.attacker,defender=m.defender;sessionStorage.setItem('frogShogiPendingMove',JSON.stringify(m));sessionStorage.setItem('mixBattle',JSON.stringify({mode:'shogi',playerRole:'attacker',attacker:'shogi-attacker',defender:'shogi-defender',attackerType:fighterType(attacker),defenderType:fighterType(defender),attackerHp:100,defenderHp:33,returnUrl:'shogi.html'}));save();location.href='index.html?mix=1&battle=1&shogi=1'}
